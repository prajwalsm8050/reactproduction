                ...
                <ProductConsumer>
                    {value => {
                        if (value.Cart.length > 0) {
                            return (
                                <div>
                                    <div><h1> Your previous order history</h1></div>
                                        ...
                                        return (
                                            <div className='container-flui text-center'>
                                                <div className='row'>
                                                    ...
                                                    {/* <div className='col-10 max-auto col-lg-2'>
                                                        <Button variant='secondary' onClick={() => { value.addToCart(cartData.id) }} size="sm">Reorder</Button>
                                                    </div> */}
                                                    <div className='col-10 max-auto col-lg-2'>
                                                        {cartData.total}
                                                    </div>

                                                    <div><NavLink to={`/home`}><input type="button" className='btn btn-primary' value="Happy Shopping"></input></NavLink></div>
                                                </div>
                                            </div>
                                        )
                                    })}
                                    ...
                                    <Container>
                                        ...
                                        {/* <Button size="lg"  onClick={() => { value.orderHistory() }} variant="secondary">
                                            { (<span>IN Cart</span>) }
                                        </Button> */}
                            ...
                            return (
                                <div>
                                    <h3>You have no order history<span style={{ color: "red" }}></span></h3>
                                </div>
                            )
                        }
                    }}
